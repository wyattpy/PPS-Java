...
<div class="login">
    ...
    <form action="servBajaContrato" method="POST">
        <label>
            <div align="center">
...
<%
    if(request.getAttribute("bajaok")!=null){
        out.println("<script>alert('Contrato eliminado con exito');</script>");
    }
    if(request.getAttribute("bajano")!=null){
        out.println("<script>alert('Contrato no encontrado');</script>");
    }
%>
</body>
</html>