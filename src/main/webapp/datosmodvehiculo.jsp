...
<%
    ...
    sesion.setAttribute("matricula",request.getAttribute("matricula"));
%>
<!DOCTYPE html>
<html lang="es">
    <head>
    ...
    <div class="formulariosGrandes">
        ...
        <form action="servModVehiculo" method="POST">
            <label>
                <input name="txtMatricula" value="<%=sesion.getAttribute("matricula")%>" type="text" readonly >
                <input name="txtMarca" value="<%=request.getAttribute("marca")%>" type="text" readonly>
                <input name="txtModelo" value="<%=request.getAttribute("modelo")%>" type="text" readonly>
                <input name="txtColor" value="<%=request.getAttribute("color")%>" type="text" required>
                <input name="txtCi_Cliente" value="<%=request.getAttribute("cliente")%>" type="text" readonly>
